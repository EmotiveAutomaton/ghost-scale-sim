...
and the selected observation usually leaves multiple laws compatible. The next useful
test is therefore a cheap target-aware query rule on a harder multi-part target, not more
precision for the current selector.
