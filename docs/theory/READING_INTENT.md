...
## §1. Reading is inverse inference of a maker — the core commitment
...
**What it says.** The reader is not a classifier of surfaces; it holds a model of a maker — a
...
## §4. Depth is compressed practice, not effort — and method, not purpose, is what transmits
