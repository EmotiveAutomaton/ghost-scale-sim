...
V18.3 separates old-task optimality from future usefulness: the exact best code for one question can discard distinctions that another question needs. The finite certificate concerns observation codes, not identified mental roles, and equal maximum storage does not equate entropy or learned decoding effort.
