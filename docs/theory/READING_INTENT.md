...
| V18.1 G3 | Stored episodes are a serious stronger representation rival | **DESCRIPTIVE (run, constructed assembly/graphic families)** | Seven parts at 128 storage tokens and 8,192 operations: episodes 93.20%, primitives 90.82%, fragments 89.42%, hybrid 88.54%. Graphic tasks saturate with primitives cheapest. Physical reconstruction and bounded replay pass; query transfer, Stitch and the admitted structural direct rival remain pending. |
