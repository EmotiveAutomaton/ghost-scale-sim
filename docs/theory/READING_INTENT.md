...
| V18.1 G2 opaque labels | Useful support evidence survives without public topological labels, and learned structure becomes necessary for action | **SPLIT: evidence benefit survives descriptively; necessity rejected in discovery** | Seven-part fixed-two success rises 78.49% to 92.69%, versus 78.78% to 95.07% with numbered parts. The direct compiler remains 100% successful using the public candidate-law union, at 177.97 versus 155 operations. Deterministic relabeling of retained structures; miniature — architecture untested. One untouched final primary is frozen and active, without a filed outcome. |
