# V19 retrospective source uncertainty
...
The independent and always-copy rivals have different report support; conditional forecast errors cannot rank them without retaining excluded probability. No new fit or protected lineage was used.

[Report](../versions/v19-local-maker/RETROSPECTIVE_SOURCE_REPORT.md).
