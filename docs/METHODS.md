...
Independent uncertainty review uses scalar label-modulo operation sums, native conditional ratios and accurate weighted sums. Paired lineage grouping uses bootstrap multiplicities and separately checks original raw rows; localization fields remain inherited identity checks. [Protocol](versions/v19-local-maker/JOINT_UNCERTAINTY_REVIEW_PROTOCOL.md).
