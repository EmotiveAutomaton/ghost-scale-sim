...
V19 remains active with 73 independently accepted scientific batches. Exact forecast-collision uncertainty is numerically verified. Full joint-goal forecast partitions and retrospective updating remain prepared alternatives; neither requires another fit or protected lineage. [Report](FORECAST_COLLISION_REPORT.md).
