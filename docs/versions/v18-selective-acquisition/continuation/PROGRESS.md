...
Larger query transfer, grounded Stitch and the structural direct rival are now
...
The first frozen final primary held on 1,152 untouched seven-part contexts. Two fixed
support observations raise task success from 79.93% to 93.08%, a 13.15-point paired
gain. Its precommitted one-sided empirical-Bernstein lower bound is 8.82 points at
error probability 0.025, above the five-point practical margin. The direct compiler
