...
import numpy as np
import pytest
from ghostscale.validation.soundingline.v19 import time_retention as S, reachable_retrospective as Q
...
def test_complete_native_parent_integration(tmp_path,corrupt):
    ...
    if corrupt:
        ...
        rows=json.loads(gzip.decompress((root/'raw/time_retention_summary_points.json.gz').read_bytes()))
