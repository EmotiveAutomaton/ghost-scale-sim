...
import numpy as np
import pytest
from ghostscale.validation.soundingline.v19 import time_retention_review as V, time_retention as S, reachable_retrospective as Q
...
def test_complete_integration_and_corruptions(tmp_path, corrupt):
    ...
    if corrupt in ('hash', 'pair', 'count'):
        ...
        path = root/'inputs/original/raw/time_retention_summary_points.json.gz'
