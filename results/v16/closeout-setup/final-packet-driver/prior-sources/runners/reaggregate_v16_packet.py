...
def inventory(root, name):
    ...
    if completion.get("execution_state") != "completed" or completion.get("instrument_state") != "valid" or completion["packet_hash"] != packet["packet_hash"]:
    ...
    for entry in entries:
        ...
        if done.get("execution_state") != "completed" or done.get("instrument_state") != "valid" or done["aggregate_sha256"] != file_digest(summary):
