    ...
    for ax, cid, xkey, ykey, arms, title in [
        ...
        for color, arm in zip(COLORS, arms):
            ...
            for x, y, row in zip(xs, ys, rows):
                ax.annotate(str(row["condition_factors"]["search_primitive_budget"]), (x,y), xytext=(4,4), textcoords="offset points", fontsize=8, color=color)
