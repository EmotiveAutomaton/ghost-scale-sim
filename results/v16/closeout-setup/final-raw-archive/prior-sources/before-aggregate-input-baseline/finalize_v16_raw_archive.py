...
def run(root, archive_root, output, input_path):
    ...
    write(output/"required_files_points.json", {"files": required,
        ...
        "excluded": "Live status, owner locks, temporary/cache files and final closeout administration; final documents/admin receipts remain in ordinary Git"})
