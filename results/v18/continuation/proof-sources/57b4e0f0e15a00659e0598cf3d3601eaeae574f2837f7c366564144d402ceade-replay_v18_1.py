...
def main():
    ...
    branch=plan['branch'];module=importlib.import_module('ghostscale.validation.soundingline.v18_1.'+{'g2-mask':'g2_mask','g2-permuted':'permuted','g2-cyclic':'cyclic_union','g2-cyclic-cost':'cyclic_union','g3-stitch':'g3_stitch','structural-direct':'direct'}.get(branch,branch.split('-')[0]))
    ...
    for name in completed['blocks']:
        ...
        for unit in block['units']:
            ...
            elif branch in ('g2-cyclic','g2-cyclic-cost'):key=tuple(case[k] for k in ('n','family'))
