    ...
    for name in completed['blocks']:
        ...
        for unit in block['units']:
            ...
            for row in unit['rows']:
                ...
                if branch in ('g1-native','g2-native','g2-transfer','g2-permuted','g2-cyclic','g3-representation','g3-stitch','structural-direct'):
                ...
                if branch in ('g2-native','g2-transfer','g2-permuted','g2-cyclic') and 'observation_record' in row:
                ...
                if branch in ('g2-native','g2-transfer','g2-permuted','g2-cyclic') and 'forecast_probes' in row:
                    predicted_truth=[]
