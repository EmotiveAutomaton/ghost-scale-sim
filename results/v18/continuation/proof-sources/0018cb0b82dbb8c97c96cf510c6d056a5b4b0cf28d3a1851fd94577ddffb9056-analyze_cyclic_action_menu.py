"""Full raw reconstruction of complete-public-action-menu cell means."""
...
result=dict(schema='v18.1.complete-menu-diagnostic.1',scope='descriptive constructed mechanism; miniature architecture untested; no third primary',
    ...
    limits=['A supplied public candidate family and an exhaustively enumerated common-valid-state menu are part of the apparatus; menu construction and physical setup are not counted in online acquisition operations.',
            'Common-valid query states do not establish free real-world access to those states; no arbitrary orientation-state menu, unknown candidate-family or architecture transfer claim.'])
