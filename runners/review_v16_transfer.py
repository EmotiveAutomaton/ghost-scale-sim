...
def review(root, heartbeat):
    output = root/"transfer-fixture-1"
    ...
    heartbeat(card_id="B01", packet_id="transfer-fixture-1", completed_units=manifest["n_tasks"],
...
def main():
    ...
    output = args.root/"transfer-fixture-1"
    target = args.root/"transfer-review-1/private/ORIGINAL_DRIVER_STATUS.json"
