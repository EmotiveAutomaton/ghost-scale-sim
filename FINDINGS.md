...
V19 remains active with 112 independently accepted scientific batches. Repeated cue dependence is independently verified. Asymmetric cue errors passed 58 isolated controls and complete-support timing; the original was observed running below normal priority through the existing serial queue, and original plus both full replays now have execution receipts. Independent numerical review belongs to their completion events. Unknown cue dependence and conditional second-cue acquisition remain prepared alternatives. Earlier timing blockers and fixture failures remain retained. The immutable interim population remains 92; twenty later acceptances are dated separately. Protected lineages, the 16-hour reserve and final time are unchanged. [Report](docs/versions/v19-local-maker/REPEATED_CUE_REPORT.md).
...
V19 remains active with 111 independently accepted scientific batches. Cue acquisition cost is independently verified. Repeated cue dependence passed 220 isolated controls and complete-support timing; the original was observed running below normal priority through the existing serial queue, and original plus both full replays now have execution receipts. Independent numerical review belongs to their completion events. Asymmetric cue errors and unknown cue dependence remain prepared alternatives. Earlier timing blockers and fixture failures remain retained. The immutable interim population remains 92; nineteen later acceptances are dated separately. Protected lineages, the 16-hour reserve and final time are unchanged. [Report](docs/versions/v19-local-maker/CUE_ACQUISITION_COST_REPORT.md).
...
V19 remains active with 110 independently accepted scientific batches. Realized-risk channel storage is independently verified. Cue acquisition cost passed 99 isolated controls and complete-support timing; the original was observed running below normal priority through the existing serial queue, and original plus both full replays now have execution receipts. Independent numerical review belongs to their completion events. Asymmetric cue errors and repeated cue dependence remain prepared alternatives. The earlier randomized-channel timing blocker and both synthetic-fixture failures remain retained. The immutable interim population remains 92; eighteen later acceptances are dated separately. Protected lineages, the 16-hour reserve and final time are unchanged. [Report](docs/versions/v19-local-maker/CHANNEL_REALIZED_RISK_REPORT.md).
...
V19 remains active with 108 independently accepted scientific batches. Precision-choice stability is independently verified. Coupled arithmetic interpolation passed 46 isolated controls and full-support timing; the existing serial queue executed its frozen original and both full replays. Independent numerical review belongs to their completion events. Regret-aware arithmetic choice and realized-risk-constrained channel regret remain prepared alternatives. The randomized-channel timing blocker remains retained. The immutable interim population remains 92; sixteen later acceptances are dated separately. Protected lineages, the 16-hour reserve and final time are unchanged. [Report](docs/versions/v19-local-maker/PRECISION_STABILITY_REPORT.md).
...
V19 remains active with 107 independently accepted scientific batches. Robust channel regret is independently verified. Randomized channel regret remains timing-blocked after one bounded cache repair, with both source versions and synthetic evidence retained. Precision stability passed 41 isolated controls and full-support timing; the existing serial queue executed its frozen original and both full replays. Independent numerical review belongs to their completion events. Coupled arithmetic interpolation and realized-risk-constrained channel regret remain prepared alternatives. The immutable interim population remains 92; fifteen later acceptances are dated separately. Protected lineages, the 16-hour reserve and final time are unchanged. [Report](docs/versions/v19-local-maker/ROBUST_CHANNEL_REGRET_REPORT.md).
...
V19 remains active with 106 independently accepted scientific batches. Cue-channel misspecification is independently verified. Robust channel regret passed 37 isolated controls and full-support timing; the existing serial queue executed its frozen original and both full replays. Independent numerical review belongs to their completion events. Precision-choice stability and randomized channel regret remain prepared alternatives. The immutable interim population remains 92; fourteen later acceptances are dated separately. Protected lineages, the 16-hour reserve and final time are unchanged. [Report](docs/versions/v19-local-maker/CHANNEL_MISSPECIFICATION_REPORT.md).

We tested whether a correctly understood cue can harm storage when the assumed source mixture is wrong. At two-thirds cue correctness, cue-guided storage performs worse than the same assumed mixture’s fixed storage choice in 671 of 5,880 mismatched problems. Independent rational reconstruction and both full replays verify this constructed-method reversal; it does not establish forecast accuracy or process correspondence.

V19 remains active with 105 independently accepted scientific batches. Prior-mixture misspecification is independently verified. Cue-reliability misspecification passed 39 isolated controls and full-support timing; the existing serial queue executed its frozen original and both full replays. Independent numerical review belongs to their completion events. Precision-choice stability and robust channel regret remain prepared alternatives. The immutable interim population remains 92; thirteen later acceptances are dated separately. Protected lineages, the 16-hour reserve and final time are unchanged. [Report](docs/versions/v19-local-maker/PRIOR_MIXTURE_REPORT.md).

We tested whether an imperfect cue about the source prior improves storage choices. With a cue that is correct two-thirds of the time, accounting for its errors improves retained coverage in 147 of 420 distinct problems. Treating the cue as certain performs worse than ignoring it in 276. Independent rational reconstruction and both full replays verify this constructed-method result; it does not establish forecast accuracy or process correspondence.

V19 remains active with 104 independently accepted scientific batches. Noisy prior disclosure is independently verified. Prior-mixture misspecification passed 26 isolated controls and full-support timing; the existing serial queue executed its frozen original and both full replays. Independent numerical review belongs to their completion events. Precision-choice stability and channel-reliability misspecification remain prepared alternatives. The immutable interim population remains 92; twelve later acceptances are dated separately. Protected lineages, the 16-hour reserve and final time are unchanged. [Report](docs/versions/v19-local-maker/NOISY_PRIOR_REPORT.md).
...
V19 remains active with 103 independently accepted scientific batches. Partial prior disclosure is independently verified. Noisy prior disclosure passed 41 isolated controls and full-support timing; the existing serial queue executed its frozen original and both full replays. Independent numerical review belongs to their completion events. Precision-choice stability and prior-mixture misspecification remain prepared alternatives. The immutable interim population remains 92; eleven later acceptances are dated separately. Protected lineages, the 16-hour reserve and final time are unchanged. [Report](docs/versions/v19-local-maker/PARTIAL_PRIOR_REPORT.md).
...
V19 remains active with 102 independently accepted scientific batches. Prior-information storage is independently verified; its initial dispatch failure remains retained. Partial prior disclosure passed 39 isolated controls and full-support timing, and the existing serial queue executed its frozen original and both full replays. Independent numerical review belongs to their completion events. Precision-choice stability and noisy prior disclosure remain prepared alternatives. The immutable interim population remains 92; ten later acceptances are dated separately. Protected lineages, the 16-hour reserve and final time are unchanged. [Report](docs/versions/v19-local-maker/PRIOR_INFORMATION_REPORT.md).
...
V19 remains active with 101 independently accepted scientific batches. Realized-risk storage is independently verified. Prior-information storage passed 41 isolated controls and complete-support timing. An initial handler-name dispatch failure is retained; a new immutable plan corrects only that name. The existing serial queue dispatched the corrected original and both full replays; execution receipts are complete and numerical review belongs to their completion events. Precision-choice stability and partial prior disclosure remain two prepared alternatives. The immutable interim population remains 92; nine later acceptances are dated separately. Protected lineages, the 16-hour reserve and final time are unchanged. [Report](docs/versions/v19-local-maker/REALIZED_RISK_STORAGE_REPORT.md).
...
V19 remains active with 99 independently accepted scientific batches. Randomized source storage is independently verified. Randomized source-prior regret passed 32 isolated controls and complete-support timing; the existing serial queue dispatched its frozen original and both full replays. Their execution receipts are complete; independent numerical acceptance belongs to completion-event review. Precision-choice stability and realized-risk-constrained storage remain two prepared alternatives. The immutable interim population remains 92; seven later acceptances are dated separately. Protected lineages, the 16-hour reserve and final time are unchanged. [Report](docs/versions/v19-local-maker/RANDOMIZED_SOURCE_STORAGE_REPORT.md).
...
V19 remains active with 98 independently accepted scientific batches. Source-prior regret is independently verified. Randomized source storage passed 37 isolated controls and complete-support timing; the existing serial queue dispatched its frozen original and both full replays. Their execution receipts are complete; independent numerical acceptance belongs to completion-event review. Precision-choice stability and randomized source-prior regret remain two prepared alternatives. The immutable interim population remains 92; six later acceptances are dated separately. Protected lineages, the 16-hour reserve and final time are unchanged. [Report](docs/versions/v19-local-maker/SOURCE_PRIOR_REGRET_REPORT.md).
...
V19 remains active with 97 independently accepted scientific batches. Robust source-prior retention is independently verified. Source-prior regret passed 33 isolated controls and complete-support timing; the existing serial queue dispatched its frozen original and both full replays. Their execution receipts are complete; independent numerical acceptance belongs to completion-event review. Precision-choice stability and randomized source storage remain two prepared alternatives. The immutable interim population remains 92; five later acceptances are dated separately. Protected lineages, the 16-hour reserve and final time are unchanged. [Report](docs/versions/v19-local-maker/ROBUST_SOURCE_MASS_REPORT.md).
...
V19 remains active with 86 independently accepted scientific batches. Forecast-horizon reconstruction and original-row regroup are complete; the frozen 155-file integration suite passed. Query-specific retention passed 97 isolated controls and was observed executing in the existing serial queue, with both full replays queued. Highest-probability source retention and retention with a query announced before compression remain prepared alternatives. Earlier timing blockers and A3/C2/F2 prerequisites are unchanged. [Report](docs/versions/v19-local-maker/RETENTION_HORIZON_REPORT.md).
...
V19 remains active with 85 independently accepted scientific batches. Time-balanced retention is independently verified. Time-localized retention passed 221 isolated controls and complete-support timing; its frozen original was observed executing in the existing serial queue, with both complete replays queued. Source-prior sensitivity and two-report dependence retain timing blockers. Highest-probability source selection and query-specific retention remain prepared alternatives. [Report](docs/versions/v19-local-maker/TIME_RETENTION_REPORT.md).
...
[Evidence and limits](docs/exchange/v18-4-L2e-paired-response.md).
...
[Evidence and limits](docs/exchange/v18-4-L2d-paired-response.md).
...
[Evidence and limits](docs/exchange/v18-4-L-odd-diverse-response.md).
...
[Evidence and limits](docs/exchange/v18-4-L-all-old-response.md).
...
[Evidence and limits](docs/exchange/v18-4-L-even-old-response.md).

## V18.4 U96: longer change-adaptation streams (19 September 2026 PDT)
...
[Evidence and limits](docs/exchange/v18-4-U96-response.md).

## V18.4 U: uncertainty over the changing role (19 September 2026 PDT)
...
[Evidence and limits](docs/exchange/v18-4-U32-response.md).
...
[Evidence and limits](docs/exchange/v18-3-source-followons-response.md).
...
[Complete cells and verification](docs/versions/v18-selective-acquisition/maker-state/RESULTS.md). Later branches remain active.
...
[technical identity and model boundary](README.md#the-latest-result-and-where-the-model-stops).
...
**1. A false provenance label does more than move a reader: it moves them away from the truth.**
...
instrument failure; twenty-two promoted cards re-run on an untouched confirmation lineage, twenty-one
held. Every card is generated into
...
Zahavian signalling, on which honesty is stable because the honest signal is *wasteful*. Signalling theory
...
## V19 changed-tool support transfer — independently verified
...
## V19 fixed likelihood tempering — numerical review pending
