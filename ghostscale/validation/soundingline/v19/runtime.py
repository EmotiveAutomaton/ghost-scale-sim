...
def run(root,campaign):
    with local_owner(campaign/'scientific-worker-owner'),local_owner(root):
        ...
        try:
            ...
            if plan['design']['handler']=='certify':
            ...
            elif plan['design']['handler']=='balanced-review':
            ...
            elif plan['design']['handler']=='context-precision-allocation':
                from .context_precision_allocation import run as handler
            elif plan['design']['handler']=='robust-context-precision':
                from .robust_context_precision import run as handler
            elif plan['design']['handler']=='context-precision-regret':
            ...
            elif plan['design']['handler']=='prior-mixture-misspecification':
            ...
            elif plan['design']['handler']=='asymmetric-channel':
                from .asymmetric_channel import run as handler
                ...
                from .channel_realized_risk import run as handler
                ...
                from .partial_prior_disclosure import run as handler
                ...
                from .time_retention import run as handler
