...
def plan(root, repo, *, include_expansion=False):
    ...
    return {"schema_version":"v16.whole-replay-plan.1","source_checks":checks,
            ...
            "exogenous_input_rule":"Inquiry's original independently sampled OS tie seed and its opaque transport ID are restored from their retained input records; no world, prediction, continuation or score is copied.",
