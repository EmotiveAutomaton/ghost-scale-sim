"""Recount supplemental source joins and replay retained known-answer witnesses."""
...
def verify_records(root, spec, refs):
    ...
    for ref in refs:
        ...
        for attack, control in record["controls"].items():
            ...
            if reproduced != control or control["instrument_state"] != "valid" or reader.index != len(reader.frames):
