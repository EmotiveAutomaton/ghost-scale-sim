...
import uuid
from .consumer_frames import EXTENSIONS, requests, scout_units
...
DESIGN = {"card_id": "X01", "scope": "fixture",
          "selection": "seed index zero in every scout condition; every recorded reader arm and phase",
...
def execute(root, output, heartbeat):
    ...
    from .transfer import Consumer
    transfer = root/"transfer-fixture-1"
