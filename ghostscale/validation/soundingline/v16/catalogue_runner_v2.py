...
from .catalogue_cases_v2 import LENSES, labels, clean_failure

PACKET = "case-catalogue-2"
MAX_CASES = 64
...
def execute(root, heartbeat=None, *, resume=False):
    ...
    sources.update([PACKAGE/"catalogue_cases.py", PACKAGE/"catalogue_runner.py", REPO/"runners/catalogue_v16.py", REPO/"tests/test_v16_catalogue.py", PACKAGE/"catalogue_cases_v2.py", PACKAGE/"catalogue_runner_v2.py", REPO/"runners/catalogue_v16_v2.py", REPO/"tests/test_v16_catalogue_v2.py"])
