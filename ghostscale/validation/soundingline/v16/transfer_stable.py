...
def envelope(frame, task_id, lineage_id):
    translated = {"ghostscale.validation.soundingline.v16.inquiry_stable:"+name: kind for name, kind in
                  [("choose", "inquiry"), ("learn_public", "inquiry-learning"),
                   ("construct_public", "inquiry-construction"), ("read_maker_public", "inquiry-reading")]}
    frame = {**frame, "kind": translated.get(frame["kind"], frame["kind"])}
...
def install_consumer(destination):
    ...
    files["v16_reference/inquiry.py"] = PACKAGE/"inquiry_stable.py"
