...
def snapshot(repo, results_root):
    ...
    for path in results_root.rglob("*"):
        ...
        # The final supervisor advances this administrative cursor after raw
        # verification. Frozen queue plans and retained failure receipts remain
        # required; only the actual root's live cursor is excluded.
        if relative.as_posix() == "operations/ACTIVE_JOB.json":
            continue
